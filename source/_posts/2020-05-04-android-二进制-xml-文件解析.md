...
有关 arsc 文件的结构和解析方法可参考：[Android arsc 文件解析](/2020/07/17/android-arsc-文件解析/)。
<!-- more -->
...
为了便于解析，这里使用了我自己写的工具类，参考这里的简介： [ObjectIO](https://github.com/l0neman/program-notes/blob/master/android-notes-reverse/utils_parse.md)。
...
[AXmlParser](https://github.com/l0neman/program-notes/blob/master/android-notes-reverse/project/android_arsc_parse/README.md) 可直接打印标准格式的文档。
